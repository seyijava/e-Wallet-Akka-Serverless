...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/com.bigdataConcept.akka.serverless.ewallet.CounterService/GetCurrentCounter -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 com.bigdataConcept.akka.serverless.ewallet.CounterService/GetCurrentCounter 
ERROR:
  Code: Unknown
